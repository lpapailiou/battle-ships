...
@Database(entities = [GameEntity::class, BoardEntity::class, ShipEntity::class, ShotEntity::class], version = 8, exportSchema = false)       // version needs to be increased if table is altered
